...
auth.onAuthStateChanged(user => {
    ...
    if (!user) {
        ...
        $("#sign-out-a").click(function(event) {
            ...
            console.log("sign");
            auth.signOut().then(() => {
                //$.redirect('/success', { 'title': "Signed out!", 'message': 'Cya! hope to see you again!', 'logout': 'true' });
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (resObj['success'] == true) {
                $.redirect('/success', { 'title': "Signed in!", 'message': 'Welcome back! glad to have you here!' });
            } else {
                alert(resObj['error']);
            }
        },
        error: function(response) {
            $.redirect('/failed', { 'title': "Can't sign you in!", 'message': 'Please try again later if it happens alot contact support team' });
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (resObj['success'] == false) {
                $.redirect('/failed', { 'title': "Can't sign you up!", 'message': 'Please try again later if it happens alot contact support team' });
            } else {
                $.redirect('/success', { 'title': "Signed up!", 'message': 'Thanks for joining to our team!' });
            }
